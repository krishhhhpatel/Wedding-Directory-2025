<?php
  ...
  if($_POST)
  {
    ...
    $query=mysqli_query($connection,"insert into tbl_category(category_name)values('{$cname}')") or die(mysqli_error($connection));
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="cname" placeholder="category_name" required/>
                      </div>
