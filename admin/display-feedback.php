        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">feedback Tables</h3>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        if(isset($_GET['did']))
                        {
                          ...
                          {
                            echo "<tr>";
                            echo "<td>{$vendorrow['feedback_id']}</td>";
                            echo "<td>{$vendorrow['user_id']}</td>";
                            echo "<td>{$vendorrow['feedback_details']}</td>";
                            echo "<td>{$vendorrow['feedback_date']}</td>";
                            echo "<td>{$vendorrow['vendor_id']}</td>";
                            echo "<td> <a href='edit-feedback.php?eid={$vendorrow['feedback_id']}'>Edit</a> | <a href='display-feedback.php?did={$vendorrow['feedback_id']}'>Delete</a>  </td>";
                            echo "</tr>";
                          }
                        ?>
                        </tbody>
